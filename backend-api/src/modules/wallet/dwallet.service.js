...
class DWalletService extends Cruds {
  ...
  async createCryptoWallet(params = {}, checkParams = true) {
    ...
    const testnet = true;
    const currentBlockChain = new BlockChain(asset.symbol, testnet);
    const {
      privateKey: pk,
      publicKey: puk,
      mnemonic,
...
module.exports = new DWalletService(WalletModel.DemoModel, WalletModel.Schema);
