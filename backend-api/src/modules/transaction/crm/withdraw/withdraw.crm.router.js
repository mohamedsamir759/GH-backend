...
router.get('/', authorizeMW('withdrawals', 'get'), validationMiddleware(vldtns.listing, true), WithdrawController.getRecords);

router.get('/gateways', authorizeMW('withdrawals', 'get'), WithdrawController.getGateways);
