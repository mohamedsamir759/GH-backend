                                        ...
                                        <div style="width: 150px; height: 56px">
                                            <a href="${keys.cpUrl}/Login" style="display: inline-flex; border-style: none !important; border: 0 !important; padding:5px; text-decoration: none; color: #244987">
                                              <!--   <img  alt="User" width="45" height="45" border="0" style="display: inline-block; height: 45px; width: 45px" src="data:image/png;base64,
                                                " alt="" /> -->
                                                <span style="background: #e6e6e6; padding: 12px 20px; width: auto"> АВТОРИЗОВАТЬСЯ </span>
                                            </div>
                                        </td>
                                    </tr>
                            </table>
                                ...
                                <table border="0" align="center" cellpadding="0" cellspacing="0" class="container580">
                                    <tr>
                                        <td align="center" style="color: #cccccc; font-size: 16px; font-family: 'Poppins', sans-serif; ">
                                            ...
                                            Любые вопросы ? Мы здесь, чтобы помочь.
                                                    ...
                                                    <tr>
                                                        <td align="center" style="color: #244987; font-size: 16px; font-family: 'Poppins', sans-serif; ">
                                                            <a href="${keys.clientWebsite}" style="text-decoration: none; font-size: 18px;  color: #244987; font-weight: 400">
                                                                ...
                                                                <img alt="Эл. адрес"  style="width: 60px; height: 55px" height="55" width="60" src="https://exiniti.blob.core.windows.net/public/icons/message.png" />
                                                                <span style="display: block">Эл. адрес</span>
                                                            </a>
                                                        </td>
                                                        <td align="center" style="color: #cccccc; font-size: 16px; font-family: 'Poppins', sans-serif; ">
                                                            <a href="${keys.clientWebsite}" style="text-decoration: none; font-size: 18px;  color: #244987; font-weight: 400">
                                                                ...
                                                                <img  alt="Вызов"  style="width: 60px; height: 55px" height="55" width="60" src="https://exiniti.blob.core.windows.net/public/icons/phone.png" />
                                                                <span style="display: block">Вызов</span>
                                                            </a>
                                                        </td>
                                                        <td align="center" style="color: #cccccc; font-size: 16px; font-family: 'Poppins', sans-serif; ">
                                                            <a href="${keys.clientWebsite}" style="text-decoration: none; font-size: 18px;  color: #244987; font-weight: 400">
                                                                ...
                                                                <img  alt="Чат"  style="width: 60px; height: 55px" height="55" width="60" src="https://exiniti.blob.core.windows.net/public/icons/chat.png" />
                                                                <span style="display: block">Чат</span>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                </table>
                        ...
                        <td align="left" style="color: #aaaaaa; font-size: 12px; font-family: 'Poppins', sans-serif; text-align:justify;">
                            <div>
                                ...
                                <span style="color: #333333;  padding-bottom: 10px; display: block">
                                    Домен ${keys.clientWebsite} управляется компанией ${keys.clientFullName}, авторизованной и регулируемой Комиссией по финансовым услугам (FSC) Республики Маврикий (номер лицензии GB19024778).
                                </span>
                    ...
                    <tr>
                        <td align="left" style="color: #aaaaaa; font-size: 12px; font-family: 'Poppins', sans-serif; text-align:justify;">
                            <div>
                                ...
                                <span style="color: #333333;  padding-bottom: 10px; display: block">
                                    Домен ${keys.clientWebsite} управляется компанией ${keys.clientFullName}, авторизованной и регулируемой Кипрской Комиссией по ценным бумагам и биржам | (CYSEC) (Номер лицензии 340/17).
                                </span>
                    ...
                    <tr>
                        <td align="left" style="color: #aaaaaa; font-size: 12px; font-family: 'Poppins', sans-serif; text-align:justify;">
                            <div>
                                ...
                                <span style="color: #333333;  padding-bottom: 10px; display: block">
                                    Предупреждение об инвестициях с высоким риском: Торговля контрактами CFD и иностранной валютой с применением маржи, сопряжена с высоким уровнем риска и может подходить не для всех инвесторов. Высокий уровень кредитного плеча может работать как в вашу пользу, так и против вас. Прежде чем принять решение о торговле иностранной валютой, вы должны тщательно проанализировать свои инвестиционные цели, уровень опыта и аппетит к риску. Существует вероятность того, что вы можете потерять часть или все свои первоначальные инвестиции, поэтому вам не следует вкладывать деньги, которые вы не можете позволить себе потерять. Вы должны помнить обо всех рисках, связанных с торговлей иностранной валютой, и обратиться за советом к независимому финансовому консультанту, в случае необходимости.
                        ...
                        <td align="left" style="color: #aaaaaa; font-size: 12px; font-family: 'Poppins', sans-serif; ">
                            <div>
                                ...
                                <span style="color: #333333;  padding-bottom: 30px; display: block">
                                    &copy; 2021 ${keys.clientName}. Все права защищены.
