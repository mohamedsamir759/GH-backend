                                        ...
                                        <div style="width: 150px; height: 56px">
                                            <a href="${keys.cpUrl}/Login" style="display: inline-flex; border-style: none !important; border: 0 !important; padding:5px; text-decoration: none; color: #244987">
                                              <!--   <img  alt="User" width="45" height="45" border="0" style="display: inline-block; height: 45px; width: 45px" src="data:image/png;base64,
                                                " alt="" /> -->
                                                <span style="background: #e6e6e6; padding: 12px 20px; width: auto"> ACCESO </span>
                                            </div>
                                        </td>
                                    </tr>
                            </table>
                                                ...
                                                <table style="padding-top: 20px" border="0" align="center" width="80%" cellpadding="0" cellspacing="0" class="container580">
                                                    <tr>
                                                        <td align="center" style="color: #244987; font-size: 16px; font-family: 'Poppins', sans-serif; ">
                                                            <a href="${keys.cpUrl}" style="text-decoration: none; font-size: 18px;  color: #244987; font-weight: 400">
                                                                ...
                                                                <img alt="Correo electrónico"  style="width: 60px; height: 55px" height="55" width="60" src="https://exiniti.blob.core.windows.net/public/icons/message.png" />
                                                                <span style="display: block">Correo electrónico</span>
                                                            </a>
                                                        </td>
                                                        <td align="center" style="color: #cccccc; font-size: 16px; font-family: 'Poppins', sans-serif; ">
                                                            <a href="${keys.cpUrl}" style="text-decoration: none; font-size: 18px;  color: #244987; font-weight: 400">
                                                                ...
                                                                <img  alt="Llamar"  style="width: 60px; height: 55px" height="55" width="60" src="https://exiniti.blob.core.windows.net/public/icons/phone.png" />
                                                                <span style="display: block">Llamar</span>
                                                            </a>
                                                        </td>
                                                        <td align="center" style="color: #cccccc; font-size: 16px; font-family: 'Poppins', sans-serif; ">
                                                            <a href="${keys.cpUrl}" style="text-decoration: none; font-size: 18px;  color: #244987; font-weight: 400">
                        ...
                        <td align="left" style="color: #aaaaaa; font-size: 12px; font-family: 'Poppins', sans-serif; text-align:justify;">
                            <div>
                                ...
                                <span style="color: #333333;  padding-bottom: 10px; display: block">
                                    El dominio www.exiniti.com está gestionado por ${keys.clientName} Limited, que está autorizada y regulada por la Financial Service Commission ( FSC ) de Mauricio (licencia nº GB19024778).
                                </span>
                    ...
                    <tr>
                        <td align="left" style="color: #aaaaaa; font-size: 12px; font-family: 'Poppins', sans-serif; text-align:justify;">
                            <div>
                                ...
                                <span style="color: #333333;  padding-bottom: 10px; display: block">
                                    El dominio ${keys.clientWebsite} está gestionado por ${keys.clientFullName}, que está autorizada y regulada por la Cyprus Securities and Exchange Commission ( CySEC ) de Chipre (licencia nº 340/17).
                                </span>
                    ...
                    <tr>
                        <td align="left" style="color: #aaaaaa; font-size: 12px; font-family: 'Poppins', sans-serif; text-align:justify;">
                            <div>
                                ...
                                <span style="color: #333333;  padding-bottom: 10px; display: block">
                                    Advertencia de inversión con riesgo elevado:Operar mediante CFD y en divisas con garantías marginales (apalancamiento) conlleva un elevado nivel de riesgo, y podría no ser apropiado para todos los inversores.El elevado grado de apalancamiento puede ir en tu contra al igual que a tu favor.Antes de decidirte a operar en divisas deberías considerar cuidadosamente tus objetivos de inversión, nivel de experiencia y apetito por el riesgo.Existe la posibilidad de que tengas que soportar la pérdida de una parte o de la totalidad de tu inversión inicial, y por consiguiente no deberías invertir dinero que no puedas permitirte perder.Deberías tener presentes todos los riesgos asociados con operar en el mercado de divisas y buscar el consejo de un asesor financiero independiente si tienes cualquier duda.
                        ...
                        <td align="left" style="color: #aaaaaa; font-size: 12px; font-family: 'Poppins', sans-serif; ">
                            <div>
                                ...
                                <span style="color: #333333;  padding-bottom: 30px; display: block">
                                    &copy; 2021 ${keys.clientName}. Reservados todos los derechos.
