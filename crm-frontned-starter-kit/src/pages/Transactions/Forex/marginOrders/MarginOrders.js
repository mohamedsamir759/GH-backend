...
import AddConvertModal from "./AddMarginOrdersModal";
  ...
  return (
    <React.Fragment>
      <Notification
        ...
        body={props.t("Margin Orders has been updated successfully")}
        show={showNotication}
        header={props.t("Margin Orders Update")}
        logo={logo}
      />
      <Row>
          ...
          <Card>
            <CardHeader className="d-flex flex-column gap-3 ">
              <div className="d-flex justify-content-between align-items-center">
                ...
                <CardTitle className="color-primary">{props.t(`Margin Orders(${props.totalDocs})`)}</CardTitle>
                <AddConvertModal />
              </div>
                  
              <div className="d-flex justify-content-between align-items-center">
                <SearchBar handleSearchInput={handleSearchInput} placeholder={props.t("Search For Margin Orders")}/>
                <div>
                  <Dropdown
                    isOpen={btnprimary1}
