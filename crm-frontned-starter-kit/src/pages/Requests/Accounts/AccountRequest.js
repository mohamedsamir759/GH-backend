...
function AccountRequest(props) {
  ...
  }, [sizePerPage, 1, props.isApproveOrReject, props.clearingCounter, filteredValues]);
            ...
            <Col className="col-12">
              <Card>
                <CardHeader className="d-flex justify-content-between  align-items-center">
                  ...
                  <AccountFilter filterChangeHandler={filterChangeHandler} filteredValues={filteredValues} />
