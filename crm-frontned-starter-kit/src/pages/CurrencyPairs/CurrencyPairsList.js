...
function CurrencyPairsList(props) {
  ...
  const columns = [
    ...
    {
      dataField: "isSpotEnabled",
      text: "Spot Config",
      formatter : (item) => <MarketConfig item={item} type={"SPOT"} />
    },
    {
      dataField: "isMarginEnabled",
      text: "Margin Config",
      formatter : (item) => <MarketConfig item={item} type={"MARGIN"} />
    },
    {
      dataField: "isFuturesEnabled",
      text: "Futures Config",
      formatter : (item) => <MarketConfig item={item} type={"FUTURES"} />
    },
    {
      dataField: "active",
      text: props.t("Active"),
                  ...
                  <div className="d-flex justify-content-between  align-items-center">
                    <CardTitle className="color-primary">
                      ...
                      <FeatherIcon
                        ...
                        onClick={() => { loadMarkets(1, sizePerPage) }}
                      />
                    </CardTitle>
