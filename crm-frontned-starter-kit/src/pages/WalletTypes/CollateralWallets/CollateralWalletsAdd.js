...
function CollateralWalletsAdd(props){
  ...
  return (
    <React.Fragment >
      <Link to="#" className="btn btn-primary " onClick={toggleAddModal}><i className="bx bx-plus me-1"></i>{props.t("Add New Collateral Wallets")}</Link>
      <Modal isOpen={addModal} toggle={toggleAddModal} centered={true}>
        <ModalHeader toggle={toggleAddModal} tag="h4">
          {props.t("Add New Collateral Wallets")}
        </ModalHeader>
        <ModalBody >
...
export default connect(mapStateToProps, null)(withTranslation()(CollateralWalletsAdd));