...
function ClientsList(props) {
  ...
  const baseColumns = [
    ...
    //     }
    //     if (val?.fx?.liveAcc) return val.fx.liveAcc[0];
    //     else if (val?.fx?.demoAcc) return val.fx.demoAcc[0];
    //   },
    // },
    // {
    //   dataField: "category",
                ...
                <CardHeader className="d-flex flex-column gap-3">
                  <div className="d-flex flex-row justify-content-between align-items-center">
                    <CardTitle className="color-primary">
                      <h5>{props.t("User List")} ({props.totalDocs}) <FeatherIcon
                        icon="refresh-cw"
