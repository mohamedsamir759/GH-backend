...
import SpotOrdersWallet from "./QuickActions/SpotOrdersWallet ";
import MarginOrdersWallet from "./QuickActions/MarginOrdersWallet";
import FuturesOrdersWallet from "./QuickActions/FuturesOrdersWallet";
import AddBonusModal from "pages/Bonus/AddBonusModal";
                  ...
                  <Card>
                    ...
                    <CardBody className="p-0">
                      ...
                      <CardBody className="quick-actions-card">
                        <p className="quick-actions-heading">User</p>
                      ...
                      {enableCrypto && (
                        <CardBody className="quick-actions-card">
                          ...
                          <div className="btn-container">
                            ...
                            <SpotOrdersWallet clientId={clientId} isLead={props.clientDetails.isLead} />
                            <MarginOrdersWallet clientId={clientId} isLead={props.clientDetails.isLead} />
                            <FuturesOrdersWallet clientId={clientId} isLead={props.clientDetails.isLead} />
                      ...
                      {enableFX && (
                        <CardBody className="quick-actions-card">
                          <p className="quick-actions-heading">Transactions</p>
                          <div className="btn-container">
                            ...
                            <AddBonusModal clientId={clientId} isLead={props.clientDetails.isLead} />
                          </div>
                        </CardBody>
                      )}
