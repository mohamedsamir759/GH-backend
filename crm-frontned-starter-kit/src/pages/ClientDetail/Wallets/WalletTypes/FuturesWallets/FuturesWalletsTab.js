...
import FuturesWalletsAdd from "./FuturesWalletsAdd";
import TableLoader from "components/Common/TableLoader";
import {
  Table, Thead, Tbody, Tr, Th, Td
} from "react-super-responsive-table";
import DeleteModal from "components/Common/DeleteModal";
import FuturesWalletsEdit from "./FuturesWalletsEdit";
import { withTranslation } from "react-i18next";
import { Link } from "react-router-dom/cjs/react-router-dom.min";

function FuturesWalletsTab(props){  
  const {wallets} = props;
  ...
  return (
    ...
    <React.Fragment>
      ...
      {/* {<FuturesWalletsEdit open={editModal}  onClose={()=>setEditModal(false)}/>} */}
...
export default connect(mapStateToProps, null)(withTranslation()(FuturesWalletsTab));