...
import TradingWalletsAdd from "./TradingWalletsAdd";
import TableLoader from "components/Common/TableLoader";
import {
  Table, Thead, Tbody, Tr, Th, Td
} from "react-super-responsive-table";
import DeleteModal from "components/Common/DeleteModal";
import TradingWalletsEdit from "./TradingWalletsEdit";
import { withTranslation } from "react-i18next";
import { Link } from "react-router-dom/cjs/react-router-dom.min";

function TradingWalletsTab(props){  
  const {wallets} = props;
  ...
  return (
    ...
    <React.Fragment>
      ...
      {/* {<TradingWalletsEdit open={editModal}  onClose={()=>setEditModal(false)}/>} */}
...
export default connect(mapStateToProps, null)(withTranslation()(TradingWalletsTab));