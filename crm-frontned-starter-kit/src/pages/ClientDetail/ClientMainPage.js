...
import ClientDeatilsCards from "./ClientDetailsCard";
import { fetchClientDetails, fetchClientStatistics } from "store/client/actions";
...
function ClientMainPage() {
  ...
  const getClientDetails = async (clientId) => {
    ...
    dispatch(fetchClientStatistics(clientId));
  };
