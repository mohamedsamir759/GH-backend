...
import AddConvertModal from "./AddFuturesOrdersModal";
...
function Convert(props){
  ...
  const columns = [
    ...
    },
    {
      ...
      formatter: (item) => (
        parseFloat(item?.toAmount?.$numberDecimal) || parseFloat(item?.toAmount) || "-"
      )
    },
    {
      dataField: "status",
  ...
  return (
    <React.Fragment>
      <Notification
        ...
        body={props.t("Futures Orders has been updated successfully")}
        show={showNotication}
        header={props.t("Futures Orders Update")}
        logo={logo}
      />
      <Row>
          ...
          <Card>
            <CardHeader className="d-flex flex-column gap-3 ">
              <div className="d-flex justify-content-between align-items-center">
                ...
                <CardTitle className="color-primary">{props.t(`Futures Orders (${props.totalDocs})`)}</CardTitle>
                <AddConvertModal />
              </div>
                  
              {/* <div className="d-flex justify-content-between align-items-center">
                <SearchBar handleSearchInput={handleSearchInput} placeholder={props.t("Search For Futures Orders")}/>
                <div>
                  <Dropdown
                    isOpen={btnprimary1}
