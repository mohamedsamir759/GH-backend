...
export const fetchOperationStagesStatsStart = (params = {}) => {
  return {
    type: FETCH_OPERATION_STAGES_STATS_START,
    payload: params
  };
};

export const fetchOperationStagesStatsSuccess = (data) => {
  return {
    type: FETCH_OPERATION_STAGES_STATS_SUCCESS,
    payload: data
  };
};

export const fetchOperationStagesStatsFailed = (error) => {
  return {
    type: FETCH_OPERATION_STAGES_STATS_FAILED,
    payload: error
  };
};
