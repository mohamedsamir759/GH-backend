import {
  ...
  FETCH_CLIENT_STATISTICS_REQUESTED,
  FETCH_CLIENT_STATISTICS_SUCCESS,
  FETCH_CLIENT_STATISTICS_FAIL,
  FETCH_CLIENT_STATISTICS_CLEAR,
...
// fetch client Statistics by id
export const fetchClientStatistics = (params = {}) => {
  return {
    type: FETCH_CLIENT_STATISTICS_REQUESTED,
    payload: params 
  };
};
export const fetchClientStatisticsSuccess = (data) => {
  return {
    type: FETCH_CLIENT_STATISTICS_SUCCESS,
    payload: data
  };
};
export const fetchClientStatisticsFail = (error) => {
  return {
    type: FETCH_CLIENT_STATISTICS_FAIL,
    payload: { error }
  };
};
export const fetchClientStatusticsClear = (data) => {
  return {
    type: FETCH_CLIENT_STATISTICS_CLEAR,
    payload: data
  };
};
