...
import LimitsList from "../pages/Limits/LimitsList";
...
import SpotOrdersIndex from "pages/Transactions/Forex/spotOrders/SpotOrdersIndex";
import MarginOrdersIndex from "pages/Transactions/Forex/marginOrders/MarginOrdersIndex";
import FuturesOrdersIndex from "pages/Transactions/Forex/futuresOrders/FuturesOrdersIndex";
...
import WalletTypesList from "pages/WalletTypes/WalletTypesList";
...
function userRoutes() {
  ...
  return [
    ...
    {
      path: "/transactions/spotorders",
      component: SpotOrdersIndex,
    },
    {
      path: "/transactions/marginorders",
      component: MarginOrdersIndex,
    },
    {
      path: "/transactions/futuresorders",
      component: FuturesOrdersIndex,
    },
    {
      path: "/dictionaries",
