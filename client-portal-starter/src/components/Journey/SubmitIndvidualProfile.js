...
import {
  Row, Col, CardBody, CardHeader, CardTitle, Button, Modal, Card
} from "reactstrap";
...
import {
  TITLES, LANGUAGES, INDUSTRIES, EMPLOYMENT_STATUS, ANNUAL_INCOME, SOURCE_OF_FUNDS, YESNO, DECLARATION, GENDER
} from "common/data/dropdowns";
import { submitIndProfile } from "store/auth/profile/actions";
                ...
                <div className="d-flex flex-column gap-4">
                  ...
                  <Row>
                    <Col md="12">
                      <div className="mt-2">
                        <AvFieldSelect
                          name="financialInfo.workedInCrypto"
                          label={props.t("I have worked for at least 2 years in a directly relevant role within the financial services industry ?")}
                          placeholder={props.t("Select have you worked in Crypto")}
                          type="text"
                          errorMessage={props.t("Required")}
                          validate={{ required: { value: true } }}
                          value={props.profile.financialInfo && props.profile.financialInfo.workedInCrypto || ""}
                  ...
                  <Row>
                    ...
                    <Col md={12}>
                      <AvField
                        name="declarations"
                        label={props.t(DECLARATION)}
                        type="checkbox"
                        errorMessage={props.t("Please check the declaration")}
                        validate={{ required: { value: true } }}
                      />
