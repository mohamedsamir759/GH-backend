          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/documents" className="">
                ...
                {/* <img src="images/logo/documents.svg" style={{  filter: "grayscale(100%)" }} width="30" height="30"></img> */}
                {/* <img src="images/logo/document.png" style={{  filter: "grayscale(100%)" }} width="26" height="26"></img> */}
            ...
            {/* <li>
              <Link to="/test" className="">
                <FeatherIcon
                  icon="home"
                />
                <span>{props.t("Test Popup Modal (only for devs)")}</span>
              </Link>
            </li> */}
          </ul>
        </div>
