...
import { makeOrder } from "../../store/orders/actions";
    ...
    <Formik
      ...
      onSubmit={(values) => {
        ...
        if (found?.amount >= values.baseAmount) {
          ...
          dispatch(showErrorNotification(`not enough ${currentMarket.marketId?.baseAsset} to sell`));
        }      
        // actions.resetForm();
          ...
          <Row className='p-0'>
            <Col xs={12}>
              ...
              <FormGroup>
                ...
                <FormText>
                  Available balance {availableBaseAmount} {baseAsset}
                </FormText>
              </FormGroup>
            </Col>
            <Swapper toggle1={toggle1}></Swapper>
            <Col xs={12}>
              <Label for="quoteAmount">I Get</Label>
              <FormGroup>
                <InputGroup>
                  <Input
                    type="text"
                ...
                <FormText>
                          Balance Will be {quoteAmountWillBe} {quoteAsset}
                </FormText>
              </FormGroup>
            </Col>
            {/* <Col xs={12}>
