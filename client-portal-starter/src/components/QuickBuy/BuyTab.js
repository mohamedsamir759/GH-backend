  ...
  >
    {({ values, setFieldValue, errors, touched }) => {
      return <RSForm tag={FormikForm}>
        <Row className='p-0'>
          <Col xs={12}>
            <Label for="quoteAmount">I Give</Label>
            <FormGroup>
              <InputGroup>
                <Input
                  type="text"
              ...
              <FormText>
                          Available balance {availableQuoteAmount} {quoteAsset}
              </FormText>
            </FormGroup>
          </Col>
          <Swapper toggle1={toggle1}></Swapper>
          <Col xs={12}>
            <Label for="baseAmount">I Get</Label>
            <FormGroup>
              <InputGroup>
                <Input
                  type="text"
              ...
              <FormText>
                          Balance Will be {baseAmountWillBe} {baseAsset}
              </FormText>
            </FormGroup>
          </Col>
          {/* <Col xs={12}>
