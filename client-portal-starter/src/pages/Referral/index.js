...
function Referral(props) {
  const getRefferalLink = () => {
    return `${content.cpUrl}/register/live?ref=${props.Profile.clientData && props.Profile.clientData.recordId}`;
  };
  return (
    <>
      <div className="referral page-content">
        ...
        <Container>
          ...
          <CardWrapper className='mb-5'>
            <p className="mb-3 fs-5">{props.t("Invite your friends to Exinitic and Earn 15% on Friends trading fees")}</p>
          ...
          <CardWrapper className='mb-5'>
            ...
            <div className="py-4 d-flex align-items-center justify-content-between border-bottom border-top">
              <div>
                ...
                <p>
                  {props.t("You are earning 20% of the trading fees your referrals pay")}
                </p>
              </div>
              <div>
                0.00 USDT
