            ...
            <CardWrapper className='mb-5 total-balance'>
              <Row className="align-items-center justify-content-between">
                ...
                <Col lg={7} className="wallet-btns">
                  <Button type="button" className='btn-danger w-lg' onClick={() => { dispatch(toggleCurrentModal("fiatWithdraw")) }}>{props.t("Withdraw")}</Button>
                  <Button type="button" className='btn-success w-lg' onClick={() => { dispatch(toggleCurrentModal("fiatDeposit")) }}>{props.t("Deposit")}</Button>
