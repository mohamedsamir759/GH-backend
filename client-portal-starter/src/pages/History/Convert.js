...
import { getConvertsStart } from "../../store/history/actions";
...
const mapStateToProps = (state)=>(
  {
    converts: state.historyReducer.converts,
    totalDocs : state.historyReducer.totalDocs,
    convertLoading: state.historyReducer.loading,
  }
);
