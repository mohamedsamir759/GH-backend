...
function DocumentUpload(props) {
  ...
  const fileSizeError = "File is too large, It has to be 2MB at most";
                ...
                {({ errors, touched, values, setFieldValue }) => (
                  ...
                  >
                          ...
                          <Col md={6}>
                            <div className="mb-3">
                              ...
                              <Input
                                ...
                                <option value="None" disabled selected hidden>Select Country (Optional)</option>
                    ...
                    <div className="text-end">
                      <Button
                        className="blue-gradient-color w-lg"
                        type="submit"
                        disabled={
                          // proof of ID + ID 
                          firstSelect === "Proof of ID" && 
                    ...
                    <div className="text-muted">
                      ({props.t("Maximum size of document 2MB")}) {props.t("Allow File Formats")} *jpg, *png, *pdf
                    </div>
                  </ReactStrapForm>
                )}
          ...
          <CardWrapper className="h-100">
            <div className="kyc-requirements">
              ...
              <div className="mt-4 proofs-container w-100">
                <button 
                  className="btn text-start py-3 border-bottom w-100" 
                ...
                <button 
                  className="btn text-start py-3 w-100" 
